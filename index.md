...
<strong>Staff Software Engineer - Platform - ActiveCampaign</strong><br/>
<strong>(June 2021 - Present)</strong>

<ul>
  <li>Implement and maintain for 100+ developers:
    <ul class="nested-compact">
      <li><a href='https://argo-cd.readthedocs.io/en/stable/' target="_blank" rel="noopener noreferrer">Argo CD</a> for multi-region kubernetes deployments</li>
      <li>internal React portal with Go backend to monitor and deploy applications to all regions</li>
      <li>developer experience tooling (local development, self-service infra, CI pipelines in GitLab)</li>
      <li>automated release tooling for central monolith codebase</li>
    </ul>
  </li>
  <li>Help design and implement migration from single monolith region to multi-region data centers</li>
  <li>Implement and maintain edge HTTP traffic routing:
    <ul class="nested-compact">
      <li>use <a href='https://emissary-ingress.dev/' target="_blank" rel="noopener noreferrer">Emissary Ingress</a> to process up to 4K req/s across multiple regions</li>
      <li>integrate with internal services to support multiple authentication paths</li>
      <li>provider developer tooling for flexible requests routing across multiple regions</li>
    </ul>
  </li>
  <li>Implement and maintain <a href='https://temporal.io/' target="_blank" rel="noopener noreferrer">Temporal</a> for mission-critical business logic</li>
...
<ul>
  <li>Implement edge traffic gateway using <a href='https://emissary-ingress.dev' target="_blank" rel="noopener noreferrer">Emissary Ingress</a> in order to help with redesign of monolithic applications</li>
  <li>Maintain self-hosted GitLab used by 150+ seats</li>
  ...
  <li>Develop custom deployment tooling used by 100+ developers for all environments</li>
  <li>Implement and maintain CI/CD pipelines in GitLab used by 100+ developers</li>
  <li>Implement and maintain local development tooling used by 100+ developers</li>
...
<ul>
  ...
  <li>Ubuntu, Red Hat Enterprise Linux</li>
  <li>Docker</li>
...
<strong>Last updated: 2026/01/30</strong>
